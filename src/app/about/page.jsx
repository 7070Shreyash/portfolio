      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              I am Shreyash, a 21-year-old B.Tech student at LNMIIT Jaipur who loves figuring out problems and doing cool coding stuff. Figuring out how complex system works.
            </p>
            {/* BIOGRAPHY QUOTE */}
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">
                    ICPC Asia-West Regionals 2023 
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    Achieved All-India-Rank 42 in ICPC Asia West Regional onsite contest held at CSJM Kanpur.{" "}
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  {/* JOB TITLE */}
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">
                    CSE Department Rank 1
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                  Consistently achieved the highest rank among 235 students in the graduating class of CSE Department at University.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2021 - Present{" "}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  {/* JOB TITLE */}
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">
                    Knight @LeetCode - Max Rating : 1903{" "}
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    Under Top 4.75% leetcoders worldwide.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2022 - Present{" "}
        ...
        {/* SVG CONTAINER */}
        <div className="h-1/2 lg:h-full lg:w-1/2 relative sticky top-0">
        {/* <div className="fixed top-0 lg:relative"> */}
